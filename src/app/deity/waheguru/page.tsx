...
export default function WaheguruPage() {
  return (
    <>
      <Head>
        <title>Waheguru Naam Jaap - वाहे गुरु | Waheguru Ji Ka Khalsa</title>
        <meta name="description" content="Chant वाहे गुरु (Waheguru) with our digital mala counter. Experience the divine grace of the Guru through sacred Sikh naam simran and jaap." />
        <meta name="keywords" content="Waheguru naam jaap, वाहे गुरु, Waheguru Ji, Sikh naam simran, Guru mantra, गुरुमुखी, Gurmukhi prayers" />
        <link rel="canonical" href="/deity/waheguru" />
        <meta property="og:title" content="Waheguru Naam Jaap - वाहे गुरु" />
        <meta property="og:description" content="Practice Sikh naam simran with digital mala counter. Connect with the divine through Waheguru chanting." />
        <meta property="og:url" content="/deity/waheguru" />
        <meta property="og:image" content="/images/waheguru-deity.jpg" />
      </Head>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white p-8 text-center">
              ...
              <p className="text-xl opacity-90">वाहे गुरु</p>
            ...
            <div className="p-8">
              <div className="prose prose-lg text-gray-700 max-w-none">
                ...
                <p>
                  Waheguru (ਵਾਹਿਗੁਰੂ) is the primary word used by Sikhs to refer to God. It means 
                ...
                <div className="bg-teal-50 border-l-4 border-teal-400 p-6 my-6">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-teal-800 mb-2">ਵਾਹਿਗੁਰੂ</p>
                    <p className="text-2xl font-bold text-teal-800 mb-2">वाहे गुरु</p>
                ...
                <ul className="space-y-2">
                  <li>🌅 <strong>Amrit Vela:</strong> Pre-dawn hours (3-6 AM) for deep meditation</li>
                  <li>📖 <strong>Gurdwara Visits:</strong> Participate in congregational worship and simran</li>
                  <li>🎵 <strong>Kirtan:</strong> Divine music and singing that elevates consciousness</li>
                  <li>🙏 <strong>Five Daily Prayers:</strong> Japji, Jaap, Tav-Prasad, Chaupai, Anand Sahib</li>
                </ul>
                ...
                <blockquote className="border-l-4 border-teal-400 pl-4 italic text-gray-600 my-8">
                  "ਵਾਹਿਗੁਰੂ ਜੀ ਕਾ ਖਾਲਸਾ, ਵਾਹਿਗੁਰੂ ਜੀ ਕੀ ਫਤਿਹ"<br/>
